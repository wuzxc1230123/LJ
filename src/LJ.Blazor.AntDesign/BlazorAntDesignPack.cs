...
using LJ.Blazor.AntDesign.StorageService;
...
public abstract class BlazorAntDesignPack : BlazorPack
{
    public override void Add(IAspNetCorePackContext packContext)
    {
        ...
        packContext.ServiceCollection.AddScoped<ILocalStorageService, LocalStorageService>();
        packContext.ServiceCollection.AddScoped<ISessionStorageService, SessionStorageService>();
    }
