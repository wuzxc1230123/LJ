...
namespace LJ.Extensions
{
    public static class MemberInfoExtensions
    {
        ...
        public static List<T> GetAttributes<T>(this MemberInfo memberInfo, bool inherit = true) where T : Attribute
        {
            return memberInfo.GetCustomAttributes(typeof(T), inherit).Cast<T>().ToList();
        }
